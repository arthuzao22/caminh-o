  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center py-12">
        <div className="text-lg text-black">Carregando veículos...</div>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-black">Meus Veículos</h1>
        <Link
      ...
      {vehicles.length === 0 ? (
        <div className="bg-white rounded-lg shadow p-12 text-center">
          <p className="text-black mb-4">Você ainda não cadastrou nenhum veículo.</p>
          <Link
            href="/dashboard/driver/vehicles/new"
            ...
            <div key={vehicle.id} className="bg-white rounded-lg shadow hover:shadow-lg transition-shadow overflow-hidden">
              ...
              <div className="p-6">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-black">{vehicle.year} • {vehicle.plate}</p>
                </div>
                ...
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-black">Publicações:</span>
